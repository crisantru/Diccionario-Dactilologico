...
Catalyst::ScriptRunner->run('Diccionario', 'Create');
...
diccionario_create.pl [options] model|view|controller name [helper] [options]
 ...
 Examples:
   ...
   diccionario_create.pl model SomeDB DBIC::Schema MyApp::Schema create=dynamic\
   dbi:SQLite:/tmp/my.db
   diccionario_create.pl model AnotherDB DBIC::Schema MyApp::Schema create=static\
